...
This is applications is witten in python fastapi web framework. This application demonstrate how to use fastapi publish message to rabbitmq and consume message from rabbitmq.
